...
import TechnologyTypes from '@/components/TechnologyConsultancy/TechnologyTypes.vue';
// import MainPortfolio from '@/components/QualityAssurance/MainPortfolio.vue';
import FooterCom from '@/components/FooterCom.vue';
import PortfolioSection from '@/components/TechnologyConsultancy/PortfolioSection.vue';

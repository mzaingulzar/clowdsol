...
import TechnologyTypes from '@/components/QualityAssurance/TechnologyTypes.vue';
// import MainPortfolio from '@/components/QualityAssurance/MainPortfolio.vue';
import FooterCom from '@/components/FooterCom.vue';
import PortfolioSection from '@/components/QualityAssurance/PortfolioSection.vue';

...
import TechnologyTypes from '@/components/BrandingService/TechnologyTypes.vue';
// import MainPortfolio from '@/components/QualityAssurance/MainPortfolio.vue';
import FooterCom from '@/components/FooterCom.vue';
import PortfolioSection from '@/components/BrandingService/PortfolioSection.vue';

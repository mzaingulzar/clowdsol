...
import TechnologyTypes from '@/components/AnnimationServices/TechnologyTypes.vue';
// import MainPortfolio from '@/components/QualityAssurance/MainPortfolio.vue';
import FooterCom from '@/components/FooterCom.vue';
import PortfolioSection from '@/components/AnnimationServices/PortfolioSection.vue';

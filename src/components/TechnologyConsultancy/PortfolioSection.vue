        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="row portR">
              ...
              <div class="col-lg-8">
                <p class="slideIntro">
                  At Black Spinel, we take a collaborative and client-centric
                  approach to technology consultancy. Our process begins with a
                  thorough assessment of your current technology landscape and
                  business objectives. We then work closely with your team to
                  develop a customized roadmap that outlines actionable steps to
                  achieve your goals. Throughout the engagement, we provide
                  ongoing support, guidance, and expertise to ensure successful
                  implementation and adoption of technology solutions on the
                  following bases.
                </p>
                <!-- <h5 class="clientRequirements">Client Requirements:</h5> -->
                <ul>
                  <li>
                    <b>Experienced Team:</b> Our team of technology experts
                    brings a wealth of experience and expertise to every
                    project.
                  </li>
                  <li>
                    <b>Tailored Solutions:</b> We understand that every business
                    is unique, which is why we tailor our solutions to meet your
                    specific needs and objectives.
                  </li>
                  <li>
                    <b>Proven Track Record:</b> With a proven track record of
                    success, we have helped numerous clients across industries
                  ...
                  <li>
                    <b>Thought Leadership:</b> As industry thought leaders, we
                    stay ahead of the curve on emerging technologies and trends

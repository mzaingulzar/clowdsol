        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="maincontainer">
              <div class="thecard">
                <div class="thefront">
                  <img src="@/assets/posters/m2.jpg" />
                </div>
                <div class="theback">
                  <img src="@/assets/posters/m8.jpg" />
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="maincontainer">
              <div class="thecard">
                <div class="thefront">
                  <img src="@/assets/posters/m3.jpg" />
                </div>
                <div class="theback">
                  <img src="@/assets/posters/m9.jpg" />
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="maincontainer">
              <div class="thecard">
                <div class="thefront">
                  <img src="@/assets/posters/m4.jpg" />
                </div>
                <div class="theback">
                  <img src="@/assets/posters/m10.jpg" />
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="maincontainer">
              <div class="thecard">
                <div class="thefront">
                  <img src="@/assets/posters/m5.jpg" />
                </div>
                <div class="theback">
                  <img src="@/assets/posters/m11.jpg" />
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="maincontainer">
              <div class="thecard">
                <div class="thefront">
                  <img src="@/assets/posters/m6.jpg" />
                </div>
                <div class="theback">
                  <img src="@/assets/posters/m12.jpg" />
                </div>
              </div>
            </div>
          </div>
